...
def evolutionary_algorithm(algorith_parameters, target_position, parking_spot, parking, start_position):
    current_best = None
    ...
    while generation < algorith_parameters[0]:
        ...
        selected = rank_selection(population, fitness_scores, int(algorith_parameters[2] / 2))

        new_population = crossover(selected, int(algorith_parameters[2] / 2), algorith_parameters[1])

        new_population = mutation(new_population, int(algorith_parameters[2] / 2), algorith_parameters[1])
...
def crossover(population, population_size, sequence_length):
...
def mutation(new_population, population_size, sequence_length):
